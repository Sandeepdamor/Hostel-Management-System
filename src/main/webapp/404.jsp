...
/* Button Styling */
        .redirect-btn {
            ...
            border-radius: 8px;
            cursor: pointer;
            box-shadow: 0px 0px 10px #ff005d;
            transition: all 0.3s ease-in-out;
        }

        .redirect-btn:hover {
            background: #ff003d;
            box-shadow: 0px 0px 15px #ff003d;
        }
...
@keyframes flicker1 {
    0%, 4%, 6%, 14%, 100% { stroke: #ff005d; }
    1%, 3%, 7%, 13% { stroke: transparent; }
}

@keyframes flicker2 {
    0%, 50%, 62%, 100% { stroke: #ff005d; }
    51%, 61% { stroke: transparent; }
}

@keyframes flicker3 {
    0%, 11%, 40%, 46%, 100% { stroke: #ff005d; }
    1%, 10%, 41%, 45% { stroke: transparent; }
}

@keyframes flicker4 {
    0%, 30%, 32%, 36%, 42%, 85%, 96%, 100% { color: #ff005d; text-shadow: 0 0 4px #ff005d; }
    31%, 37%, 41%, 86%, 95% { color: #12000a; text-shadow: 0 0 4px #12000a; }
}

@keyframes fadeInText {
    1% { color: #12000a; text-shadow: 0 0 4px #12000a; }
    70% { color: #ff005d; text-shadow: 0 0 14px #ff005d; }
    100% { color: #ff005d; text-shadow: 0 0 4px #ff005d; }
}
...
<body>
	<div>
		<div>
			<svg id="svgWrap_2" xmlns="http://www.w3.org/2000/svg" x="0px"
				y="0px" viewBox="0 0 700 250">
  <g>
    <path id="id3_2"
    ...
    <path id="id1_2"
			...
			<svg id="svgWrap_1" xmlns="http://www.w3.org/2000/svg" x="0px"
				y="0px" viewBox="0 0 700 250">
  <g>
    <path id="id3_1"
					d="M195.7 232.67h-37.1V149.7H27.76c-2.64 0-5.1-.5-7.36-1.49-2.27-.99-4.23-2.31-5.88-3.96-1.65-1.65-2.95-3.61-3.89-5.88s-1.42-4.67-1.42-7.22V29.62h36.82v82.98H158.6V29.62h37.1v203.05z" />
  ...
  <defs>
    <filter id="glow">
	 ...
	 <button class="redirect-btn" onclick="redirectToLanding()">Go to Landing Page</button>
		 <script>
        function redirectToLanding() {
            window.location.href = '/HostelManagementSystem';
        }
    </script>	
