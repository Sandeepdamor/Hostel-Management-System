...
<body>
    ...
    <div class="content">
        ...
        <div class="container mt-4">
            <h2 class="text-center">Add Student Again</h2>
            <form action="../../../HostelManagementSystem/admin" method="post">
                ...
                <div class="input-group">
				 ...
				 <input type="hidden" id="email" name="email" value="<%=student!=null ? student.getEmail() : ""%>">
                <!-- Submit Button -->
                <button type="submit" name="action" value="addagain" class="submit-btn">Add Student Again</button>
                <button type="submit" class="cancel-btn" name="action" value="addStudentAgain">Cancel</button>
            </form>
        </div>
    </div>
        ...
        if (urlParams.get("success") !== null) { // Ensure the parameter is explicitly checked
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = '../../admin?action=studentshistory';
                }
            });
        }
    });
