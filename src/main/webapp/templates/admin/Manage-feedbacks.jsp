...
<body>
	...
	<div class="content">
		...
		<div class="container">
			<div class="d-flex justify-content-between align-items-center mb-3">
				<form action="admin" method="post">
           			<div class="input-group"> 
    					...
    					<button class="btn btn-warning" style="width: 100px; height: 38px;" type="submit" name="action" value="searchfeedback">Search</button>
					</div>
				</form>
			</div>
			<table class="table table-bordered text-center">
				...
				<tbody>
					<%
					List<Grievance> feedbacks = (List<Grievance>) request.getAttribute("feedbacks");
					%>
					<%
					...
					<tr>
						...
						<td><%=feedback.getResponse()!=null ? feedback.getResponse(): "--"	%></td>
						<td>
				...
				<div class="modal-body">
					<form id="responseForm">
						...
						<div class="mb-3">
    						...
    						<div id="responseError" class="text-danger mt-1" style="display: none;"></div>
						</div>
	...
	$(document).ready(function () {
	    ...
	    $('#responseModal').on('show.bs.modal', function (event) {
	        ...
	        $('#responseError').hide(); // Hide previous error message
	    });
	    ...
	    $('#responseForm').on('submit', function (e) {
	        ...
	        var responseText = $('#responseText').val().trim(); // Get the response text
	        var responseError = $('#responseError'); // Select the error message container

	        // Validate response field
	        if (responseText === '') {
	            responseError.text('Response is required').show(); // Show error message
	            return false; // Stop form submission
	        } else {
	            responseError.hide(); // Hide error message if valid
	        }
