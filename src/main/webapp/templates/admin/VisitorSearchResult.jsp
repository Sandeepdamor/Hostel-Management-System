    ...
    <div class="content">
        ...
        <div class="container">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
               <a style="text-decoration: none; color: red;" href="admin?action=managvisitors"><button class="btn btn-add">Close Search Result</button></a>
            </div>
            <table class="table table-bordered text-center">
                ...
                <tbody>
                    <%
                    List<Visitor> visitors = (List<Visitor>) request.getAttribute("searchdata");
